...
<div class="container mt-5">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            ...
            <input type="text" id="product_desc" name="product_desc" value="<?php echo $product_desciption ?>" class="form-control" required="required">
        </div>
...
if(isset($_POST['edit_product'])){
    ...
    or $product_brands=='' or $product_image1=='' or $product_image2=='' or $product_image2==''
    or $product_image3=='' or $product_price==''){
        ...
        $update_product = "update products set product_title='$product_title', product_desciption=' $product_desc',
        product_keywords='$product_keywords', category_id=$product_category, brand_id='$product_brands',product_image1=
        '$product_image1',product_image2='$product_image2',product_image3='$product_image3',product_price=' $product_price',
