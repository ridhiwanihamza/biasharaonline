...
if(isset($_POST['insert_product'])){
    ...
    if($product_title == '' or $description=='' or  $product_keywords=='' or $product_category==''
     or $product_brands=='' or $product_price=='' or  $product_image1=='' or  $product_image2=='' or  $product_image3==''){
        ...
        //insert query
        $insert_products = "insert into products (product_title,product_desciption,product_keywords,category_id,brand_id,product_image1,
        product_image2,product_image3,product_price,date,status)  values('$product_title','$description',' $product_keywords',
            ...
            <div class="form-outline mb-4 w-50 m-auto">
             ...
             <div class="form-outline mb-4 w-50 m-auto">
               ...
               <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_keywords" id="product_keywords" class="form-control" placeholder="Enter product keyword"
                autocomplete="off" required="required">
            </div>
